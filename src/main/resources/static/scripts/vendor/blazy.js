/*! 
  ...
  (c) rijosh - @bklinggaard - https://pgsuae.com
*/
(function (root, blazy) {
  ...
  return function Blazy(options) {
    ...
    scope.options.container = scope.options.containerClass
      ? document.querySelectorAll(scope.options.containerClass)
      : false;
  ...
  function validate(self) {
    ...
    for (var i = 0; i < util.count; i++) {
      ...
      if (
        elementInView(element, self.options) ||
  ...
  function loadElement(ele, force, options) {
    ...
    if (
      ...
      if (dataSrc) {
        ...
        var src =
          dataSrcSplitted[_isRetina && dataSrcSplitted.length > 1 ? 1 : 0];
