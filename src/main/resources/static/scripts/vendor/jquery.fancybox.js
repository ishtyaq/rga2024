  ...
  $.extend(FancyBox.prototype, {
    ...
    showLoading: function (slide) {
      ...
      if (slide && !slide.$spinner) {
        slide.$spinner = $(self.translate(self, self.opts.spinnerTpl)).appendTo(
          slide.$slide
        );
      }
    },
    ...
    getThumbPos: function (slide) {
      var self = this,
        ...
        thumbPos =
          $thumb && $thumb.length && $thumb[0].ownerDocument === document
            ? $thumb.offset()
            : 0,
        slidePos;
        ...
        $.each(self.instance.slides, function (index, slide) {
          ...
          if (slide.pos === self.instance.current.pos) {
            self.sliderStartPos.left =
              ...
              $.fancybox.getTranslate(self.instance.$refs.stage).left;
          }
        });
